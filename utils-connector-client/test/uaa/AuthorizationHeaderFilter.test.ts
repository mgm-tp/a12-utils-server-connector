...
//
// import { AuthorizationHeaderFilter } from "./AuthorizationHeaderFilter";

// describe("com.mgmtp.a12.connector.request.authorizationHeaderFilter", () => {
// 	it("test default init authorization header filter", async () => {
// 		const requestFilterChain = new FilterChain();
// 		const bodyFilter: AuthorizationHeaderFilter =
...
// 			'{"_headers":{"authorization":["Bearer custom Token String"]}}',
// 			"header authorization not there"
// 		);
// 	});
// });
