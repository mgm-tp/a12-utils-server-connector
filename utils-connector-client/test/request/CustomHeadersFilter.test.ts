...
// import { CustomHeadersFilter } from "../../main/internal/filter/request/CustomHeadersFilter";
//
// describe("com.mgmtp.a12.connector.request.services.customHeaderFilter", () => {
// 	it("test custom headers filter", async () => {
// 		const requestFilterChain = new FilterChain();
// 		requestFilterChain.registerFilterRequest(new HeadersFilter());
// 		requestFilterChain.registerFilterRequest(new CustomHeadersFilter());
